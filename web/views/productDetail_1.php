    ...
    <div class="single row">
        <div class="banner-top col-md-12">
            <div class="container col-md-6 col-md-offset-3">
                <h1>Fan</h1>
                <em></em>
                <h2><a href="../index.php">Home</a><label>/</label>Fan</a></h2>
            </div>
        </div>
        <div class="col-md-6">
            <div>
                ...
                <form class="panel panel-default text-center" ng-app="myApp" ng-controller="myCtrl"
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <p class="quick_desc"> Since Song dynasty, China began to produce folding fans, most of which are made of paper sticking around, and seldom are silk.</p>


                            <div class="btn-group btn-group-justified  col-xs-10   col-sm-10  col-md-10  col-lg-10">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-danger tybtn" onclick="pressChange(this);">blue
                                    </button>
                                </div>
                                <div class="btn-group">
                                    <button type="button" class="btn btn-danger tybtn" onclick="pressChange(this);">
                                        green
                                    </button>
                                </div>
                                <div class="btn-group">
                                    <button type="button" class="btn btn-danger tybtn" onclick="pressChange(this);">grey
                                    </button>
                                </div>
                                <div class="btn-group">
                                    <button type="button" class="btn btn-danger tybtn" onclick="pressChange(this);">
                        ...
                        <div class="row">
                            ...
                            <div
                                class="input-group number-spinner input-append col-xs-offset-1 col-xs-10  col-sm-offset-5 col-sm-6 col-md-offset-6 col-md-5 col-lg-offset-7 col-lg-4">
