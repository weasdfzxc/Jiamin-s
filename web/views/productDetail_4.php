        ...
        <div class="single">
            <div class="banner-top col-md-12">
                <div class="container col-md-6 col-md-offset-3">
                    <h1>Chinaware</h1>
                    <em></em>
                    <h2><a href="../index.php">Home</a><label>/</label>Chinaware</a></h2>
                </div>
            </div>
                ...
                <div>
                        <div id="myCarousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="item active"><img src="../Images/plate/panzi2.png" alt="Image1"></div>
                                <div class="item"><img src="../Images/plate/panzi3.png" alt="Image2"></div>
                                <div class="item"><img src="../Images/plate/panzi4.png" alt="Image3"></div>
                            </div>
                    ...
                    <div>
                        <form class="panel panel-default text-center" ng-app="myApp" ng-controller="myCtrl"
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <p class="in-para"> Improve the quality of life.</p>
                                    <h4 class="quick">Quick Overview:</h4>
                                    <p class="quick_desc"> It's an important part of Chinese culture, Chinese achievements in science and technology in the pursuit of beauty and shape, are reflected through the ceramic prouduction in many aspects</p>


                                    <div class="row">
                                        <div class="btn-group btn-group-justified  col-xs-10  col-sm-10  col-md-10  col-lg-10">
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-info tybtn" onclick="pressChange(this);">qinghua</button>
                                            </div>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-info tybtn" onclick="pressChange(this);">huangyou</button>
                                            </div>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-info tybtn" onclick="pressChange(this);">caiyou</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
