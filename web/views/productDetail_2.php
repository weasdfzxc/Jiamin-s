        ...
        <div class="single">
            <div class="banner-top col-md-12">
                <div class="container col-md-6 col-md-offset-3">
                    <h1>Papercut</h1>
                    <em></em>
                    <h2><a href="../index.php">Home</a><label>/</label>Papercut</a></h2>
                </div>
            </div>
                ...
                <div>
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active"><img src="../Images/papercut/fu.png" alt="Image1"></div>
                            <div class="item"><img src="../Images/papercut/fu2.png" alt="Image2"></div>
                        </div>
                ...
                <div>
                    <form class="panel panel-default text-center" ng-app="myApp" ng-controller="myCtrl"
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <p class="in-para"> Double Happiness.</p>
                                <h4 class="quick">Quick Overview:</h4>
                                <p class="quick_desc">Chinese Paper cutting is a picture cut out on a paper with scissors.The picture patterns are often pasted on the linteis,windows,or lanterns to express the feelings of joy and the perceptions in life</p>


                                <div class="btn-group btn-group-justified  col-xs-10   col-sm-10  col-md-10  col-lg-10">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-info tybtn" onclick="pressChange(this);">pingan</button>
                                    </div>
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-info tybtn" onclick="pressChange(this);">xinnian</button>
                                    </div>
                                </div>
                            </div>
                            <br>
